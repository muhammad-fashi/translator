...
$als_active    = (string) Settings::get( 'provider', 'manual' );
?>

<section class="als-card">
	<h2 class="als-card__title"><?php esc_html_e( 'Translation Provider', 'advanced-language-switcher' ); ?></h2>
	<p class="als-card__intro"><?php esc_html_e( 'Providers are adapters behind a shared interface, so switching engines never changes your stored translations.', 'advanced-language-switcher' ); ?></p>
			...
			<label class="als-provider" for="als-provider-<?php echo esc_attr( (string) $als_slug ); ?>">
				...
				<span class="als-provider__body">
					...
					<span class="als-provider__meta">
						<?php if ( ! $als_provider->is_automatic() ) : ?>
						...
						<?php else : ?>
							<span class="als-badge als-badge--missing"><?php esc_html_e( 'API key required', 'advanced-language-switcher' ); ?></span>
						<?php endif; ?>
					</span>
				</span>
			</label>
...
<section class="als-card">
	<h2 class="als-card__title"><?php esc_html_e( 'API Keys', 'advanced-language-switcher' ); ?></h2>
